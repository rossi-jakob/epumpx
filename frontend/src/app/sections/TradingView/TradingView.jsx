        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-3 items-start">
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-2 mt-6">
              ...
              <Button className="text-md font-bold text-white" onClick={() => setCommentToggle(false)}>Trades</Button>
            </div>
            {
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-[#191C2F] rounded-4xl p-6">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                {
                  !swapToggle ? <Button className="font-bold text-white text-md" onClick={() => setSwapToggle(false)}>Buy</Button> :
                    <Button variant="outline" className="font-bold text-white text-md" onClick={() => setSwapToggle(false)}>Buy</Button>
                }
                {
...

              {
                !swapToggle && <div className="text-sm bg-gradient-to-r from-[#0CA1B7] to-[#AB9003] bg-clip-text text-transparent mb-2 flex flex-1 justify-between">
                  ...
                  <Button className="text-white" onClick={() => handleMax()}>MAX</Button>
                </div>
              }
              <div className="text-sm text-white mb-4">Balance: {!swapToggle ? tokenInfo.epixBal : tokenInfo.balance}</div>
              ...
              <span className="text-white mt-5 px-2 block text-sm font-bold">
                There are <b className="text-md">{curveInfo ? (Number(curveInfo.totalSupply) - Number(curveInfo.supply)).toFixed(2) : "1000,000,000"} {curveInfo ? curveInfo.symbol : "Token"}</b> still
                available for sale in the bonding curve and there is{" "}
                <b className="text-md">{curveInfo?.funds} EPIX </b>(
                <b className="text-md">Raised amount: 18.8 EPIX</b>)in the bonding curve.
                When the market cap reaches <b className="text-md">${Number(curveInfo.mc).toFixed(2)}</b> all
